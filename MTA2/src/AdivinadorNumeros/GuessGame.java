...
public class GuessGame {
	   ...
	   public void startGame() {
	       ...
	       System.out.println ("Estoy pensando en un numero entre 0 y 9...");
	       ...
	       while(true) {
	           ...
	           {
	               System.out.println("Nosotros tenemos un Jugador ganador!");
	               ...
	               break; // game over, so break out of the loop / rompemos el loop
	           }
	           else {
	        	   // Nadie ha adivinado, nos mantenemos en el juego aun!
	               System.out.println("Los jugadores probaran adivinar otra vez.");
	           } // end if/else
